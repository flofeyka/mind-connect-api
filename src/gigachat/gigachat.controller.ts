...
export class GigachatController {
  ...
  @Put('/:dialogId')
  @UseGuards(AuthGuard)
  async updateDialog(@Param('dialogId') dialogId: UUID, @Body() updateDialogDto: CreateDialogDto): Promise<DialogsDto> {
    return this.gigachatService.updateDialog(dialogId, updateDialogDto);
  }
